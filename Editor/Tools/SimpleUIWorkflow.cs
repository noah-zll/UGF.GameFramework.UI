...
namespace UGF.GameFramework.UI.Editor
{
    ...
    public static class SimpleUIWorkflow
    {
        ...
        private static string GenerateBindingClass(UIDesigner designer)
        {
            ...
            string baseClassName = designer.BaseType == UGF.GameFramework.UI.UIBaseType.MonoBehaviour ? "MonoBehaviour" : "UIFormBase";
            sb.AppendLine($"{indent}public partial class {designer.UIFormName} : {baseClassName}");
            ...
            if (designer.BaseType == UGF.GameFramework.UI.UIBaseType.UIFormBase)
            {
                // 生成BindComponents方法
                sb.AppendLine($"{indent}    /// <summary>");
